...
mov cx,0x8000           ;this is my mask to invert the corresponding bit in bx register
...
shr cx,1           ;shift lefting the by one
...
out1:
shl cx,1          ;shifting right the cx once to nullify one exta shift left 
